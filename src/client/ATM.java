        ...
        switch (operation){
            ...
            case "deposit":
                try {
                    ...
                    balance = bank.deposit(amount, sessionID);
            ...
            case "withdraw":
                try {
                    ...
                    balance = bank.withdraw(amount, sessionID);
            ...
            case "inquiry":
                try {
                    ...
                    Account acc = bank.inquiry(sessionID);
                    System.out.println("--------------------------\nAccount Details:\n--------------------------\n" +
                            "Account Number: " + acc.getAccountNumber() +
                            "\nUsername: " + acc.getUserName() +
            ...
            case "statement":
                ...
                try {
                    ...
                    s = (Statement) bank.getStatement( startDate, endDate, sessionID);
    ...
    public static void getCommandLineArguments(String args[]) throws InvalidArgumentException{
        ...
        switch (operation){
            ...
            case "inquiry":
                ...
                sessionID = Long.parseLong(args[3]);
                break;
            case "statement":
				try{
					startDate = new SimpleDateFormat("dd/MM/yyyy").parse(args[3]);
					//startDate = new java.util.Date(args[3]);
					endDate =new SimpleDateFormat("dd/MM/yyyy").parse(args[4]);
				}
				catch(Exception e)
				{
					e.printStackTrace();
